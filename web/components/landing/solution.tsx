...
export default function SolutionSection() {
    return (
        <section className="pt-8 pb-16 lg:pt-12 lg:pb-24 bg-background/50" id="solution">
            <div className="container px-6 md:px-6 mx-auto max-w-7xl">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {inclusions.map((item, i) => (
                        <div key={i} className="group p-6 lg:p-10 rounded-3xl lg:rounded-[2.5rem] bg-card border border-border shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 flex flex-col items-start gap-6 lg:gap-8 h-full">
